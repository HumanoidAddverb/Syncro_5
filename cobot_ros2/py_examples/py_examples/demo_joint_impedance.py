...
class JointImpedanceTestClient(Node):

    def __init__(self):

        super().__init__("joint_impedance_test_client")

        self.sent = False

        self.get_logger().info(
            "Joint Impedance Test Client Node Initialized"
        )
    ...
    def send_goal(self):
        ...
        goal_msg.trajectory.points.append(pt1)
        ...
        goal_msg.trajectory.points.append(pt2)
        ...
        pt3.time_from_start = Duration(
            seconds=15.0
        ).to_msg()

        goal_msg.trajectory.points.append(pt3)
