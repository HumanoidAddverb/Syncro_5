...
class EffortPublisher : public rclcpp::Node
{
    ...
    : Node("demo_effort")
    {
      publisher_ = this->create_publisher<std_msgs::msg::Float64MultiArray>("/arm_1_effort_controller/commands", 10);
  ...
  private:
    ...
    void timer_callback()
    {
      ...
      effort.data.emplace_back(18.3965);
      effort.data.emplace_back(-18.3965);
      effort.data.emplace_back(-0.989842);
      effort.data.emplace_back(0.07603);
      effort.data.emplace_back(0.0);      
